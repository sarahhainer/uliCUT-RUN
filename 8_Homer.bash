...
findPeaks CR1_1-120/ -style factor -o auto -P 1 -poisson 0.01 -F 0.5 -L 2 -LP 0.001 -i CR1noab_1-120/
findPeaks CR1_150-500/ -style histone -o auto -P 1 -poisson 0.01 -F 0.5 -L 2 -LP 0.001 -i CR1noab_150-500/
